...
<div class="col-xl-8">
    ...
    <a href="<?php echo route_to('order.order-cart.adding-item', session()->getTempdata('order_id')); ?>" type="button" class="btn btn-secondary btn-sm mb-3">Voltar</a>

    <div class="card">
        <div class="card-body pt-3">

            <div class="tab-content pt-2 mt-3">
                <form class="user" method="post" action="<?php echo route_to('order.order-cart.add-item', $storageId); ?>">

                    <input type="hidden" name="<?php echo csrf_token(); ?>" value="<?php echo csrf_hash(); ?>">
                    
                    <input type="hidden" name="order_id" value="<?php echo session()->getTempdata('order_id'); ?>">
