...
<div class="col-lg-12">
    ...
    <a href="<?php echo route_to('order.order-cart-show', session()->getTempdata('order_id')); ?>" type="button" class="btn btn-secondary btn-sm mb-3">Voltar</a>

    <form class="user" method="get" action="<?php echo url_to('order.order-cart.adding-item', $orderId); ?>">
                        ...
                        <?php foreach ($storageList as $storage) : ?>
                            ...
                            <tr>
                                ...
                                <th class="text-center">
                                    <a href="<?php echo route_to('order.order-cart.add-item-quantity', encrypt($storage->id)); ?>" type="button" class="btn btn-primary btn-sm"><i class="ri-add-circle-fill"></i></a>
                                </th>
                            </tr>
