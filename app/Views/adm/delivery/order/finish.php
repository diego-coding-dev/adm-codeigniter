...
<div class="card-body mt-5">
    ...
    <div class="pt-4 pb-2">
        ...
        <h5 class="text-center">Confirmar pedido para <?php echo esc($client->name); ?>?</h5>

        <div class="text-center mt-4">

            <form class="user" method="post" action="<?php echo route_to('order.finish-confirm', $orderId); ?>">
