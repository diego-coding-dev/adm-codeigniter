...
<div class="col-lg-12">
    ...
    <form class="user" method="get" action="<?php echo url_to('order.list-client'); ?>">
                        ...
                        <?php foreach ($clientList as $cliente) : ?>
                            ...
                            <tr>
                                ...
                                <th class="text-center" style="width: 100px;">
                                    <a href="<?php echo route_to('order.select-client', encrypt($cliente->id)); ?>" type="button" class="btn btn-primary btn-sm">Selecionar</a>
                                </th>
                            </tr>
